...
**C6. A test-support crate — scaffolding landed in S4a; the fake is S4b.** Twenty-one `impl AgentHarness for` fakes, twelve copies of
...
| 4 | C6 test-support crate; migrate the server integration tests to it — **scaffolding landed in S4a; the shared fake is S4b** | tests only | −3000 |
