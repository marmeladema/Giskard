...
pub const COMPLETED_TURN_HARNESS_THREAD_ID: &str;                           // "th_tok", shared by completed_turn_fixture and tests registering its persisted thread
